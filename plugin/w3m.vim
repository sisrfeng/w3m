...
com!     -nargs=* -complete=file LW3mLocal :call w3m#Open(g:w3m#OPEN_NORMAL, 'local', <f-args>)
com!     -nargs=* -complete=customlist,w3m#search_engine#List WW3m :call w3m#Open(g:w3m#OPEN_NORMAL, <f-args>)
com!     -nargs=* -complete=customlist,w3m#search_engine#List TW3m :call w3m#Open(g:w3m#OPEN_TAB, <f-args>)
com!     -nargs=* -complete=customlist,w3m#search_engine#List SW3m :call w3m#Open(g:w3m#OPEN_SPLIT, <f-args>)
com!     -nargs=* -complete=customlist,w3m#search_engine#List VW3m :call w3m#Open(g:w3m#OPEN_VSPLIT, <f-args>)
com!     -nargs=0 WW3mHistory :call w3m#history#Show()
com!     -nargs=0 WW3mHistoryClear :call w3m#history#Clear()
